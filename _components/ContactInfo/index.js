    ...
    <div className={`w-100 bg-red-200 ${props.className || ''}`} style={{ width: '100%' }}>
      <Row className="max-w-screen-xl py-4 text-left text-gray mx-auto">
        <Col md={{ span: 8 }} className="p-3" >
          ...
          <div className="text-base md:text-lg">Mã số thuế: 23424234234</div>
          <div className="text-base md:text-lg">Địa chỉ: 40/18/09 Tô Vĩnh Diện, Khương Đình, Thanh Xuân, Hà Nội</div>
        </Col>
        <Col md={{ span: 8 }} className="p-3 text-base md:text-lg text-justify" >
